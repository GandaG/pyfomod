...
class Test_Check_Errors:
    ...
    def test_moduleflagdepend(self):
        tree = etree.fromstring("<config>"
                                "<moduleName/>"
                                "<moduleDependencies operator='And'>"
                                "<flagDependency "
                                ...
                                "</installSteps>"
                                "</config>")
        expected = [([1], "Flag Dependency in Module Dependencies",
                     "moduleDependencies is using flagDependency - "
                     "at this point no flags have been set which means "
